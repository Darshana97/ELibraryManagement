                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                               ...
                               <div class="form-group">
                                   <asp:TextBox CssClass="form-control" ID="TextBox4" runat="server" placeholder="Contact Number" ReadOnly="True" TextMode="Phone"></asp:TextBox>
                               </div>
                            </div>
                            <div class="col-md-5">
                        ...
                        <br />
                         ...
                         <div class="row">
                            ...
                            <div class="col-md-4">
                               <label>City</label>
                               <div class="form-group">
                                   <asp:TextBox CssClass="form-control" ID="TextBox10" runat="server" placeholder="City" ReadOnly="True" TextMode="SingleLine"></asp:TextBox>
                               </div>
                            </div>
                            <div class="col-md-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-8 mx-auto">
                                <asp:Button Width="100%" class="btn btn-lg btn-block btn-danger" ID="Button4" runat="server" Text="Delete User Permenently" />
                            </div>
                        </div>
